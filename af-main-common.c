...
void emAfStackStatusHandler(EmberStatus status)
{
  ...
  switch (status) {
    ...
    case EMBER_RECEIVED_KEY_IN_THE_CLEAR:
    	emberAfAppPrintln("EMBER_RECEIVED_KEY_IN_THE_CLEAR");
        emberAfAppFlush();
        emberAfStackDown();
        break;
    case EMBER_NO_NETWORK_KEY_RECEIVED:
    	emberAfAppPrintln("EMBER_NO_NETWORK_KEY_RECEIVED");
        emberAfAppFlush();
        emberAfStackDown();
        break;
    case EMBER_NO_LINK_KEY_RECEIVED:
    	emberAfAppPrintln("EMBER_NO_LINK_KEY_RECEIVED");
        emberAfAppFlush();
        emberAfStackDown();
        break;
    case EMBER_PRECONFIGURED_KEY_REQUIRED:
    	emberAfAppPrintln("EMBER_PRECONFIGURED_KEY_REQUIRED");
        emberAfAppFlush();
        emberAfStackDown();
        break;
    case EMBER_MOVE_FAILED:
    	emberAfAppPrintln("EMBER_MOVE_FAILED");
        emberAfAppFlush();
        emberAfStackDown();
        break;
    case EMBER_JOIN_FAILED:
    	emberAfAppPrintln("EMBER_JOIN_FAILED");
        emberAfAppFlush();
        emberAfStackDown();
        break;
    case EMBER_NO_BEACONS:
    	emberAfAppPrintln("EMBER_NO_BEACONS");
        emberAfAppFlush();
        emberAfStackDown();
        break;
    case EMBER_CANNOT_JOIN_AS_ROUTER:
    	emberAfAppPrintln("EMBER_CANNOT_JOIN_AS_ROUTER");
        emberAfAppFlush();
        emberAfStackDown();
        break;
    case EMBER_NETWORK_DOWN:
    	emberAfAppPrintln("EMBER_NETWORK_DOWN");
        emberAfAppFlush();
        emberAfStackDown();
        break;
    default:
